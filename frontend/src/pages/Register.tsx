    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center p-4 text-zinc-900 dark:text-zinc-100 transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-xl shadow-xl border border-zinc-200 dark:border-zinc-800 p-8">
        <div className="text-center mb-8">
          <img src="/frontend/public/Nutri Agent - Logo Nome Horizontal.png" alt="NutriAgent" className="h-16 w-auto object-contain mx-auto mb-4" />
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          {error && (
            <div className="text-red-500 text-sm text-center bg-red-100 dark:bg-red-500/10 py-2 rounded-md border border-red-200 dark:border-red-500/20">
              {error}
            </div>
          )}
