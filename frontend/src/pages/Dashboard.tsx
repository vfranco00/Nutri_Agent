...
import {
  ...
  CheckCheck,
  Shield,
} from "lucide-react"; // Adicionei Shield
import {
  AreaChart,
  Area,
  XAxis,
...
export function Dashboard() {
  ...
  function getLevel(score: number = 0) {
    ...
    if (score < 500)
      return { title: "Chef", icon: "👨‍🍳", next: 500, color: "text-blue-500" };
    return {
      title: "MasterChef",
      icon: "👑",
      next: 1000,
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400">
          Acompanhe seu progresso e gerencie sua dieta.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-zinc-800 to-zinc-900 rounded-xl p-6 text-white shadow-lg border border-zinc-700 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs text-zinc-400 text-right">
            Próximo nível em {level.next - (user?.score || 0)} XP
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div
          onClick={() => navigate("/profile")}
          className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-green-500 transition-all cursor-pointer group hover:-translate-y-1 shadow-sm"
        >
        ...
        <div
          ...
          className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-orange-500 transition-all cursor-pointer group hover:-translate-y-1 shadow-sm"
        >
        ...
        <div
          ...
          className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-purple-500 transition-all cursor-pointer group hover:-translate-y-1 shadow-sm"
        >
        ...
        <div
          ...
          className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-blue-500 transition-all cursor-pointer group hover:-translate-y-1 shadow-sm"
        >
        ...
        <div
          ...
          className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-pink-500 transition-all cursor-pointer group hover:-translate-y-1 shadow-sm"
        >
      ...
      {user?.is_superuser && (
        <div className="space-y-4">
          ...
          >
            ...
            <div>
              <h3 className="text-lg font-semibold mb-1 dark:text-white text-red-600 dark:text-red-500">
                Painel Admin
              </h3>
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
